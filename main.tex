...
\newcommand{\yisup}{\bm{y}^{(i)}}
\newcommand{\yisupred}{\hat{\bm{y}}^{(i)}}
\newcommand{\supervised}{(\xisup,\yisup)}
\newcommand{\xmat}{\bm{X}}
\newcommand{\apsimple}{\textsc{\char13}} % The char ' 
\newcommand{\ytarget}{\textbf{\mathup{y}}}
\newcommand{\ypred}{\hat{\textbf{{\mathup{y}}}}}
...
\include{ape-joyplots}
\include{ape-statistical-pvalues}
\include{ape-delta-plots}      % associado ao arquivo: 'ape-delta-plots.tex'
\include{ape-sfm-plots}
