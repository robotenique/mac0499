...
\begin{enumerate}
    ...
    \begin{table}[!h]
        ...
        \begin{tabular}{lrrr}
            ...
            \bottomrule
            \end{tabular}
        \caption{SFM model for scenario $S(C_1, \eta^{(1)}_{max\_depth}, Brier)$}
...
\begin{table}[!h]
    ...
    \begin{tabular}{||c|lccccccc||}
        ...
        \bottomrule
    \end{tabular}
    \caption{All experimental scenarios and their respective Kruskal–Wallis results for equality of treatment means; The \ok represents that the test statistic is significant at $\alpha = 0.05$ and \notok otherwise (cannot reject $H_0$)}
    \label{table:kek}
\end{table}
